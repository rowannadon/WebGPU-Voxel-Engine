...
def parse_args():
    ...
    ap.add_argument('--z-max', type=float, default=4096.0, help="Elevation (m) at heightmap value 255.")
    ...
    ap.add_argument('--coast-decay-km', type=float, default=650.0, help="e-folding distance for moisture decay from coasts (km).")
