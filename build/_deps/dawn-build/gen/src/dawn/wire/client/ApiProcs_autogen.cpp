...
DAWN_WIRE_EXPORT WGPUFuture wgpuDawnWireClientBufferMapAsync2(WGPUBuffer cSelf, WGPUMapModeFlags mode, size_t offset, size_t size, WGPUBufferMapCallbackInfo2 callbackInfo) {
    auto self = reinterpret_cast<dawn::wire::client::Buffer*>(cSelf);
    return self->MapAsync2( mode,  offset,  size,  callbackInfo);
}
...
DAWN_WIRE_EXPORT WGPUFuture wgpuDawnWireClientShaderModuleGetCompilationInfo2(WGPUShaderModule cSelf, WGPUCompilationInfoCallbackInfo2 callbackInfo) {
    auto self = reinterpret_cast<dawn::wire::client::ShaderModule*>(cSelf);
    return self->GetCompilationInfo2( callbackInfo);
}
...
namespace {
    ...
    static const ProcEntry sProcMap[] = {
        ...
        { reinterpret_cast<WGPUProc>(wgpuDawnWireClientBufferMapAsync2), "wgpuBufferMapAsync2" },
        ...
        { reinterpret_cast<WGPUProc>(wgpuDawnWireClientShaderModuleGetCompilationInfo2), "wgpuShaderModuleGetCompilationInfo2" },
...
namespace dawn::wire::client {
    ...
    constexpr DawnProcTable MakeProcTable() {
        ...
        procs.bufferMapAsync2 = wgpuDawnWireClientBufferMapAsync2;
        ...
        procs.shaderModuleGetCompilationInfo2 = wgpuDawnWireClientShaderModuleGetCompilationInfo2;
