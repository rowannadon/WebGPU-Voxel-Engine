...
namespace dawn::wire::client {
    ...
    WireResult Client::HandleBufferMapAsyncCallback(DeserializeBuffer* deserializeBuffer) {
        ...
        return DoBufferMapAsyncCallback(cmd.eventManager, cmd.future, cmd.status, cmd.status2, cmd.message, cmd.userdataCount, cmd.readDataUpdateInfoLength, cmd.readDataUpdateInfo);
    }
