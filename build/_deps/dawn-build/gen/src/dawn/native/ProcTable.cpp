...
namespace dawn::native {
    ...
    WGPUFuture NativeBufferMapAsync2(WGPUBuffer cSelf, WGPUMapModeFlags mode, size_t offset, size_t size, WGPUBufferMapCallbackInfo2 callbackInfo) {
        auto self = FromAPI(cSelf);
        ...
        auto result =        self->APIMapAsync2(mode_, offset_, size_, callbackInfo_);
        return *ToAPI(&result);
    }
    ...
    WGPUFuture NativeShaderModuleGetCompilationInfo2(WGPUShaderModule cSelf, WGPUCompilationInfoCallbackInfo2 callbackInfo) {
        auto self = FromAPI(cSelf);

        auto callbackInfo_ = callbackInfo;
        // This method is specified to not use AutoLock in json script or it returns a future.

        auto result =        self->APIGetCompilationInfo2(callbackInfo_);
        return *ToAPI(&result);
    }
    ...
    namespace {
        ...
        static const ProcEntry sProcMap[] = {
            ...
            { reinterpret_cast<WGPUProc>(NativeBufferMapAsync2), "wgpuBufferMapAsync2" },
            ...
            { reinterpret_cast<WGPUProc>(NativeShaderModuleGetCompilationInfo2), "wgpuShaderModuleGetCompilationInfo2" },
    ...
    constexpr DawnProcTable MakeProcTable() {
        ...
        procs.bufferMapAsync2 = NativeBufferMapAsync2;
        ...
        procs.shaderModuleGetCompilationInfo2 = NativeShaderModuleGetCompilationInfo2;
