...
void Application::saveHeightTexture() {
    ...
    // 
    int width = 4096;
    int height = 4096;
...
void Application::MainLoop() {
    ...
    renderImGUI();
    // this function writes the uniforms
